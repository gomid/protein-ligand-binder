...
def build_model(input_shape=(21, 21, 21, 3)):
    ...
    x = Conv3D(filters=16, kernel_size=(11, 11, 11), padding='valid', activation='relu')(input_grid)
    x = Conv3D(filters=32, kernel_size=(6, 6, 6), padding='valid', activation='relu')(x)
